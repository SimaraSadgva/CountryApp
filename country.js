  1393, 447400, 1002450, 196722, 65610, 6220, 147570, 1285216, 710, 783562,
  652230, 180, 236, 242900, 752612, 338424, 1267000, 135, 12, 36125, 86600,
  2511, 23200, 120538, 2040, 102, 347, 1141748, 131990, 56594, 446550, 2381741,
  14000000, 41850, 1886068, 18272, 160, 147181, 8870, 69700, 881912, 2.02,
  582000, 10452, 462840, 374, 48671, 36, 49, 11586, 587041, 3287590, 185180,
  13812, 17364, 406752, 21041, 603500, 572, 825615, 83600, 110879, 2166086,
  357114, 181035, 438317, 7747, 450295, 109884, 199951, 17098242, 330803, 964,
  9251, 9984670, 118484, 2149690, 51209, 1104300, 505992, 20273, 309500, 242,
  30, 61, 30355, 181, 34, 103000, 2586, 2780400, 948, 21, 14, 266000, 751,
  51100, 7692024, 513120, 27750, 26, 112492, 28051, 616, 4167, 207600, 64559,
  459, 1628, 342353, 6, 43094, 475442, 245857, 765, 163820, 2344858, 637657,
  78865, 18575, 12189, 394, 56785, 151, 580367, 260, 412, 26338, 45227, 238391,
  5130, 214969, 14874, 331212, 181034, 0.44, 1104, 83871, 442, 488100, 801590,
  75417, 702, 70273, 444, 83534, 323802, 1580, 622984, 272967, 117600, 945087,
  100210, 89342, 1030700, 65300, 34.2, 49037, 1246700, 2724900, 33846, 1240192,
  12173, 29743, 2842, 116, 377930, 1098581, 756102, 9372610, 389, 54, 452, 60,
  108889, 276841, 1128, 143100, 316, 10689, 923768, 13943, 10908, 17818, 300,
  619745, 1648195, 28748, 8515767, 88361, 22966, 676578, 38394, 916445, 111369,
  10991, 312679, 264, 5765, 1862, 549, 747, 811, 238533, 1284000, 390757, 53,
  1564110, 92090, 199, 342000, 30528, 20770, 270467, 130373, 91,
];
let img = [
...
function yenile() {
  let n = rnd(0, 250);
  country.innerHTML = `
            <div class="imgflag"><img src="${img[n]}" alt="Country flag"></div>
                <div class="countryinfo">
                    <h3><a href="#">${name[n]}</a></h3>
                    <h4><a href="#">${region[n]}</a></h4>
                    <p>Capital: <span class="capital">${capital[n]}</span></p>
                    <p>Area: <span class="area">${area[n]} km<sup>2</sup></span></p>
                    <p>Population: <span class="population">${population[n]}</span></p>
                 </div>`;
}
yenile();
...
function show2(say) {
  ...
  <div class="country">
                  <div class="flags">
                      <img src="${img[i]}" alt="country flag">
                  </div>
                  <div class="info">
                      <h5>${region[i]}</h5>
                      <h4>${name[i]}</h4>
                      <div class="countriesinfo">
                          <div>Population: <span>${population[i]}</span></div>
                          <div>${area[i]} km<sup>2</sup></div></span>
                      </div>
                  </div>
              </div>
  `;
