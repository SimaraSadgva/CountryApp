...
function yenile() {
  ...
  let object = data[rnd(0, 250)];
  country.innerHTML = `
            <div class="imgflag"><img src="${object.flag}" alt="Country flag"></div>
                <div class="countryinfo">
                    <h3><a href="#">${object.name}</a></h3>
                    <h4><a href="#">${object.region}</a></h4>
                    <p>Capital: <span class="capital">${object.capital}</span></p>
                    <p>Area: <span class="area">${object.area} km<sup>2</sup></span></p>
                    <p>Population: <span class="population">${object.population}</span></p>
                 </div>`;
                 console.log(data[rnd(0, 250)]);
